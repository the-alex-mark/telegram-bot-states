...
return [
    ...
    |
    | Примечание:
    |    Каналы "api", "debug", "updates" и "errors" являются техническими и
    |    используются в ядре модуля. Их удаление приведёт к неполадкам в
    |    работе функционала системы состояний чат-бота.
    |
    */
